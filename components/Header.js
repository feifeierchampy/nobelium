...
const NavBar = () => {
  ...
  const links = [
    ...
    { id: 1, name: locale.NAV.TOOLS, to: 'https://tools.feifeier.com', show: true, external: true },
    { id: 2, name: locale.NAV.APPS, to: 'https://www.freoza.com', show: true, external: true},
